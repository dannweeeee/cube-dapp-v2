...
import { useFetchUserTransactionsByAddress } from "@/hooks/useFetchUserTransactionsByAddress";

export default function TransactionsTable() {
  const { address } = useAccount();
  const { transactions, loading, error } = useFetchUserTransactionsByAddress(
    address ?? null
  );
